...
public class UserFixtures {
    ...
    public static IllegalArgumentException 유저_아이디_길이_유효성_검증실패_예외메시지 = new IllegalArgumentException(
    ...
    public static IllegalArgumentException 유저_비밀번호_길이_유효성_검증실패_예외메시지 = new IllegalArgumentException(
        "비밀번호는 8자 이상 15자 이하로 입력해주세요.");
    public static IllegalArgumentException 유저_비밀번호_정규식_유효성_검증실패_예외메시지 = new IllegalArgumentException(
